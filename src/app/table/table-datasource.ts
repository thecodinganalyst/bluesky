...
export class TableDataSource extends DataSource<TableDataType> {
   ...
   */
  connect(): Observable<TableDataType[]> {
   ...
   */
  private getPagedData(data: TableDataType[]): TableDataType[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TableDataType[]): TableDataType[] {
    ...
    return data.sort((a, b) =>
      compare(a[sortCol], b[sortCol], isAsc)
    );
  }
}
